...
namespace Bank
{
    public partial class Сontribution : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "bankDataSet.ОбменныйКурсВалют". При необходимости она может быть перемещена или удалена.
            this.обменныйКурсВалютTableAdapter.Fill(this.bankDataSet.ОбменныйКурсВалют);
            // TODO: данная строка кода позволяет загрузить данные в таблицу "bankDataSet.ВидыВкладов". При необходимости она может быть перемещена или удалена.
            this.видыВкладовTableAdapter.Fill(this.bankDataSet.ВидыВкладов);
            // TODO: данная строка кода позволяет загрузить данные в таблицу "bankDataSet.ВидыВкладов". При необходимости она может быть перемещена или удалена.
            this.видыВкладовTableAdapter.Fill(this.bankDataSet.ВидыВкладов);
