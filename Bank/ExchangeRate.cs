...
namespace Bank
{
    public partial class ExchangeRate : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            finally { conn.Close(); this.обменныйКурсВалютTableAdapter.Fill(this.bankDataSet.ОбменныйКурсВалют); 
                textBox1.Text = ""; 
                textBox2.Text = "";
                panel1.Show();
                panel2.Hide();
                ...
                case DialogResult.Yes:
                    {
                        ...
                        finally { conn.Close(); this.обменныйКурсВалютTableAdapter.Fill(this.bankDataSet.ОбменныйКурсВалют); panel1.Hide();
                            panel2.Hide();
                        }
                        break;
                    }
