...
namespace Bank
{
    public partial class RegistrationСontribution : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "bankDataSet.View_1". При необходимости она может быть перемещена или удалена.
            this.view_1TableAdapter.Fill(this.bankDataSet.View_1);
                ...
                case DialogResult.Yes:
                    {
                        ...
                        finally { conn.Close(); this.view_1TableAdapter.Fill(this.bankDataSet.View_1); }
                        break;
                    }
            }
        }
