...
namespace Bank
{
    public partial class Staff : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "bankDataSet.Сотрудники". При необходимости она может быть перемещена или удалена.
            this.сотрудникиTableAdapter.Fill(this.bankDataSet.Сотрудники);
                ...
                case DialogResult.Yes:
                    {
                        ...
                        finally { conn.Close(); this.сотрудникиTableAdapter.Fill(this.bankDataSet.Сотрудники); }
                        break;
                    }
            }
        }
